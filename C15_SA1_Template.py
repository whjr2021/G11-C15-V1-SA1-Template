...
# Student Avctivity 1- Step 1: Replace databse URL with the database created in TA1
...
if player_count < 100:
    ...
    player1 = Player(player_count,"John", 140, 450)
    ...
    while carryOn:
        ...
        # Student Activity 1- Step 2: Retrieve real-time player data from Car Racing database and print it 
        # The db_get_data() user defined function is used to retrieve data from database.
        # Pass "player_count" variable value as the input into db_get_data() function 
